...
export default class Transaction {
    ...
    static transactionReward({ miner }) {
        return new this({ input: REWARD_ADDRESS, outputMap: { [miner.publicKey]: MINING_REWARD } });
    };

    update({ sender, recipient, amount }) {
        if (amount > this.outputMap[sender.publicKey]) throw new Error('Not enough founds')
